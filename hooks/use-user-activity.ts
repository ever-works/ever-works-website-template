...
// Use a fixed base date for consistent mock data
const BASE_DATE = new Date('2024-01-15T12:00:00Z').getTime();
...
const mockActivities: UserActivity[] = [
  {
    ...
    rating: 5,
    createdAt: new Date(BASE_DATE - 30 * 60 * 1000), // 30 minutes ago
  },
  {
    id: "2",
    ...
    type: "vote",
    voteType: "upvote",
    createdAt: new Date(BASE_DATE - 2 * 60 * 60 * 1000), // 2 hours ago
  },
  {
    id: "3",
    ...
    rating: 4,
    createdAt: new Date(BASE_DATE - 4 * 60 * 60 * 1000), // 4 hours ago
  },
  {
    id: "4",
    ...
    type: "vote",
    voteType: "upvote",
    createdAt: new Date(BASE_DATE - 6 * 60 * 60 * 1000), // 6 hours ago
  },
  {
    id: "5",
    ...
    rating: 5,
    createdAt: new Date(BASE_DATE - 8 * 60 * 60 * 1000), // 8 hours ago
  },
  {
    id: "6",
    ...
    type: "vote",
    voteType: "downvote",
    createdAt: new Date(BASE_DATE - 12 * 60 * 60 * 1000), // 12 hours ago
  },
  {
    id: "7",
    ...
    rating: 4,
    createdAt: new Date(BASE_DATE - 1 * 24 * 60 * 60 * 1000), // 1 day ago
  },
  {
    id: "8",
    itemId: "jest-testing",
    type: "vote",
    voteType: "upvote",
    createdAt: new Date(BASE_DATE - 1.5 * 24 * 60 * 60 * 1000), // 1.5 days ago
  },
  {
    id: "9",
    ...
    rating: 4,
    createdAt: new Date(BASE_DATE - 2 * 24 * 60 * 60 * 1000), // 2 days ago
  },
  {
    id: "10",
    itemId: "git-workflow",
    type: "vote",
    voteType: "upvote",
    createdAt: new Date(BASE_DATE - 2.5 * 24 * 60 * 60 * 1000), // 2.5 days ago
  },
  {
    id: "11",
    ...
    rating: 3,
    createdAt: new Date(BASE_DATE - 3 * 24 * 60 * 60 * 1000), // 3 days ago
  },
  {
    id: "12",
    ...
    type: "vote",
    voteType: "upvote",
    createdAt: new Date(BASE_DATE - 3.5 * 24 * 60 * 60 * 1000), // 3.5 days ago
  },
];
