      ...
      <div className={MODAL_CONTAINER_CLASS}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select
              className="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2 focus:outline-hidden focus:ring-2 focus:ring-red-400 focus:border-red-400 transition"
              value={reason}
