...
export function PricingSection({ onSelectPlan }: PricingSectionProps) {
  ...
  const freePlanFeatures: PlanFeature[] = [
    ...
    { included: true, text: t("FREE_PLAN_FEATURES.PERMANENT_LINK_MAINTENANCE") },
  ...
  const sponsorPlanFeatures: PlanFeature[] = [
    ...
    { included: true, text: t("SPONSOR_PLAN_FEATURES.AVAILABLE_FOR_ALL_PRODUCTS") },
    { included: true, text: t("SPONSOR_PLAN_FEATURES.ONE_ADVERTISEMENT_PER_PERIOD") },
    { included: true, text: t("SPONSOR_PLAN_FEATURES.SCHEDULE_ADVERTISING") },
    { included: true, text: t("SPONSOR_PLAN_FEATURES.PREMIUM_CUSTOMER_SUPPORT") },
  ];
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-7xl">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <div className="mt-8 inline-flex items-center gap-3 p-1 rounded-xl bg-gray-200/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-300/30 dark:border-gray-700/30">
            <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/60 dark:bg-gray-900/60">
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{t("NO_HIDDEN_FEES")}</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/60 dark:bg-gray-900/60">
              <Zap className="w-4 h-4 text-gray-600 dark:text-gray-400" />
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{t("INSTANT_ACTIVATION")}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <div className={cn(
              ...
              selectedPlan === "free" && "ring-2 ring-blue-500/50 dark:ring-blue-400/50"
            )}>
              <PlanCard
                plan="free"
                title="FREE"
          ...
          >
            ...
            <div className={cn(
              ...
              selectedPlan === "pro" && "ring-2 ring-purple-500/50 dark:ring-purple-400/50"
            )}>
              <PlanCard
                plan="pro"
                title="PRO"
          ...
          >
            ...
            <div className={cn(
              "relative transition-all duration-500 hover:scale-105 hover:-translate-y-2",
              selectedPlan === "sponsor" && "ring-2 ring-cyan-500/50 dark:ring-cyan-400/50"
            )}>
              <PlanCard
                plan="sponsor"
                title="SPONSOR"
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">
                    {t("GREAT_CHOICE")} {selectedPlan.charAt(0).toUpperCase() + selectedPlan.slice(1)} {t("PLAN")}
                  </p>
        ...
        <div className="mt-16 text-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { icon: Check, title: t("INSTANT_ACTIVATION"), desc: t("GET_STARTED_IMMEDIATELY") },
              { icon: Zap, title: t("NO_SETUP_FEES"), desc: t("PAY_ONLY_WHAT_YOU_USE") },
              { icon: Shield, title: t("PREMIUM_SUPPORT"), desc: t("EXPERT_ASSISTANCE") }
            ].map((item, index) => (
              <div 
                key={index} 
