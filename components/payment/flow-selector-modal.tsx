...
import { Modal, ModalContent, ModalHeader, ModalBody, Card, useDisclosure } from '@heroui/react';
								...
								return (
									...
									>
										<div className="p-4 flex items-start gap-3">
											<div
												className={cn(
													'w-10 h-10 rounded-lg bg-theme-primary-500 dark:bg-theme-primary-600 flex items-center justify-center',
													isSelected &&
														'ring-2 ring-theme-primary-200 dark:ring-theme-primary-700'
												)}
											>
