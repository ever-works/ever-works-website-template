...
import { CreditCard, Lock, Check, Shield, Sparkles, ArrowLeft, Star, Globe, Zap } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Secure checkout with enterprise-grade encryption and fraud protection
          </p>
        </div>
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center p-6 bg-gradient-to-r from-gray-50/80 to-blue-50/80 dark:from-gray-900/40 dark:to-blue-900/40 rounded-2xl border border-gray-200/30 dark:border-gray-700/30">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-bold text-gray-900 dark:text-white">{getPlanName()}</h4>
                        {selectedPlan === "sponsor" ? (
                          <p className="text-sm text-gray-600 dark:text-gray-400">Billed weekly • Premium features</p>
                        ) : selectedPlan === "pro" ? (
                          <p className="text-sm text-gray-600 dark:text-gray-400">One-time payment • Pro features</p>
                        ) : (
                          <p className="text-sm text-gray-600 dark:text-gray-400">Free forever • Basic features</p>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 rounded-2xl border border-green-200/50 dark:border-green-700/30">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-700 dark:text-green-400 leading-relaxed">
                          Your payment is protected by 256-bit SSL encryption, PCI DSS Level 1 compliance, and processed securely through Stripe.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-3xl border border-white/20 dark:border-gray-700/30 p-8 shadow-2xl">
                  ...
                  <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-2xl border border-blue-200/50 dark:border-blue-700/30">
                    <p className="text-sm text-blue-800 dark:text-blue-300 leading-relaxed">
                      To list your product in our directory, there is a one-time fee of {getPlanPrice()}. This helps us maintain the quality of listings and support the platform.
                    </p>
                  </div>
                  ...
                  <div className="grid gap-8">
                    ...
                    <div className="space-y-3">
                      <label htmlFor="cardName" className="block text-sm font-bold text-gray-700 dark:text-gray-300">
                        Name on card
                      </label>
                      <div className="relative">
                        <input
                          ...
                          className={cn(
                            ...
                            focusedField === 'cardName' && "scale-[1.02] shadow-xl ring-4 ring-blue-500/20",
                            completedFields.has('cardName') && "border-green-500/70 bg-green-50/40 dark:bg-green-900/20 ring-2 ring-green-500/20"
                          )}
                        />
                    ...
                    {/* Card Number */}
                    <div className="space-y-3">
                      <label htmlFor="cardNumber" className="block text-sm font-bold text-gray-700 dark:text-gray-300">
                        Card number
                      </label>
                      <div className="relative">
                        <input
                          ...
                          className={cn(
                            ...
                            focusedField === 'cardNumber' && "scale-[1.02] shadow-xl ring-4 ring-blue-500/20",
                            completedFields.has('cardNumber') && "border-green-500/70 bg-green-50/40 dark:bg-green-900/20 ring-2 ring-green-500/20"
                          )}
                        />
                        <div className="absolute right-4 top-1/2 transform -translate-y-1/2 flex items-center gap-3">
                          ...
                          <div className={cn(
                            "w-10 h-6 rounded flex items-center justify-center transition-colors duration-300",
                            getBrandFromCardNumber(paymentInfo.cardNumber) === 'visa' ? "bg-blue-600 text-white" :
                            getBrandFromCardNumber(paymentInfo.cardNumber) === 'mastercard' ? "bg-red-600 text-white" :
                            getBrandFromCardNumber(paymentInfo.cardNumber) === 'amex' ? "bg-green-600 text-white" :
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        <label htmlFor="expiry" className="block text-sm font-bold text-gray-700 dark:text-gray-300">
                          Expiry date
                        </label>
                        <div className="relative">
                          <input
                            ...
                            className={cn(
                              "w-full h-14 px-6 pr-14 text-lg bg-gray-50/80 dark:bg-gray-900/50 border-2 border-gray-200/60 dark:border-gray-600/50 rounded-2xl transition-all duration-300 focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-blue-400 hover:border-gray-300 dark:hover:border-gray-500 outline-none text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400",
                              focusedField === 'expiry' && "scale-[1.02] shadow-xl ring-4 ring-blue-500/20",
                              completedFields.has('expiry') && "border-green-500/70 bg-green-50/40 dark:bg-green-900/20 ring-2 ring-green-500/20"
                            )}
                          />
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={cn(
                              "w-full h-14 px-6 pr-14 text-lg bg-gray-50/80 dark:bg-gray-900/50 border-2 border-gray-200/60 dark:border-gray-600/50 rounded-2xl transition-all duration-300 focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-blue-400 hover:border-gray-300 dark:hover:border-gray-500 outline-none text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400",
                              focusedField === 'cvc' && "scale-[1.02] shadow-xl ring-4 ring-blue-500/20",
                              completedFields.has('cvc') && "border-green-500/70 bg-green-50/40 dark:bg-green-900/20 ring-2 ring-green-500/20"
                            )}
                          />
                ...
                <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-3xl border border-white/20 dark:border-gray-700/30 p-8 shadow-2xl">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="group p-4 rounded-2xl bg-gray-50/80 dark:bg-gray-900/40 hover:bg-white/80 dark:hover:bg-gray-800/60 transition-all duration-300 hover:scale-105 border border-gray-200/30 dark:border-gray-700/30">
                        <div className="flex items-start gap-4">
                          <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center", 
                            item.color.includes('blue') ? 'bg-blue-100 dark:bg-blue-900/30' :
