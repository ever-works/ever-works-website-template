        ...
        <div className="flex-1">
          <div className="flex items-center gap-4 mb-4">
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
              ...
              isCancelled ? 'bg-red-100 dark:bg-red-700/50' :
              isTrialing ? 'bg-theme-primary-100 dark:bg-theme-primary-20' :
              'bg-slate-100 dark:bg-slate-700/50'
            } group-hover:scale-105 transition-transform duration-300 dark:bg-theme-primary-20`}>
              <PlanIcon className={`w-6 h-6 ${
                isActive ? 'text-emerald-600' :
                isCancelled ? 'text-red-600' :
                isTrialing ? 'text-theme-primary-600' :
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3">
                <span className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium border ${statusConfig.bgColor} ${statusConfig.color} ${statusConfig.borderColor} dark:border-slate-500`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-4">
            ...
            <div className="flex items-center gap-2 text-slate-600 dark:text-slate-300">
              ...
              <span>
                <span className="font-medium">Ended:</span> {subscription.endDate ? formatDate(subscription.endDate) : 'Ongoing'}
              </span>
            </div>
          </div>
