                ...
                >
                  ...
                  <div className="text-left">
                    <div className="flex items-center gap-2">
                      ...
                      {tab.count !== undefined && (
                        <span className="inline-flex items-center justify-center w-5 h-5 text-xs font-medium bg-slate-100 dark:bg-slate-700/50 text-slate-600 dark:text-slate-400 rounded-full dark:border dark:border-slate-500">
                          {tab.count}
                        </span>
                      )}
                    </div>
