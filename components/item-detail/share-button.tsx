      ...
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            className={cn(
              "w-48 bg-white dark:bg-gray-800 rounded-xl shadow-lg",
          ...
          >
            <DropdownMenu.Item
              className="flex items-center px-3 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer outline-none text-gray-700 dark:text-gray-200"
