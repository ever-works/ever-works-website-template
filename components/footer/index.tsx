...
export function Footer() {
  ...
  return (
    <footer className="relative w-full overflow-hidden footer-fade-in">
      {/* Glassmorphism Background instead of opaque */}
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-8">
              {Object.entries(footerLinks).map(([category, links], categoryIndex) => {
                ...
                return (
                  <div key={category} className={`space-y-4 footer-stagger-item`} style={{ animationDelay: `${(categoryIndex + 2) * 0.1}s` }}>
                    <h4 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider">
          ...
          {/* Bottom section */}
          <div className="mt-16 pt-8 border-t border-gray-200/50 dark:border-gray-700/50 footer-stagger-item" style={{ animationDelay: '0.7s' }}>
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                ...
                <span className="hidden sm:inline">{t("ALL_RIGHTS_RESERVED")}.</span>
            ...
            <div className="mt-4 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100/50 dark:bg-gray-800/50 backdrop-blur-sm text-xs text-gray-500 dark:text-gray-400">
                ...
                ></div>
                <span>{t("CURRENT_THEME")}: {currentThemeInfo.label}</span>
              </div>
            </div>
          </div>
        </div>
