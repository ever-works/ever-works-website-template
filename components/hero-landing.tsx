...
export function HeroLanding({
  ...
  const fullText = title || t('HERO_IN_MINUTES');
  ...
  const containerClasses = cn(
    "relative text-gray-900 dark:text-white transition-all duration-300",
    {
      'min-h-screen': variant === 'fullscreen',
      'min-h-[80vh]': variant === 'default',
      'min-h-[60vh]': variant === 'compact',
    },
    className
  );

  const backgroundClasses = cn(
    "bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-black",
    {
      'min-h-screen': variant === 'fullscreen',
      'min-h-[80vh]': variant === 'default',
      'min-h-[60vh]': variant === 'compact',
  ...
  return (
    <div className={cn(backgroundClasses, containerClasses)}>
      ...
      <PageContainer className="relative z-10 px-4 py-8">
        ...
        <div className="text-center max-w-6xl mx-auto">
          ...
          {customContent ? (
            ...
            <>
              {/* Main Title */}
              <h1 className={cn(
                "font-bold text-gray-900 dark:text-white mb-8 transition-all duration-1000 delay-300",
                {
                  'text-5xl md:text-6xl lg:text-7xl xl:text-8xl': variant === 'fullscreen',
                  'text-4xl md:text-5xl lg:text-6xl': variant === 'default',
                  'text-3xl md:text-4xl lg:text-5xl': variant === 'compact',
                },
              ...
              {/* Subtitle */}
              <p className={cn(
                "text-gray-600 dark:text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed transition-all duration-1000 delay-500",
                {
                  'text-lg md:text-xl lg:text-2xl': variant === 'fullscreen',
                  'text-lg md:text-xl': variant === 'default',
                  'text-base md:text-lg': variant === 'compact',
                },
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              )}>
                {subtitle || (
              ...
              <div className={cn(
                ...
                {
                  'mb-20': variant === 'fullscreen',
                  'mb-16': variant === 'default',
                  'mb-12': variant === 'compact',
                },
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              )}>
                                 {primaryCTA?.href ? (
                   ...
                   >
                     <span className="flex items-center gap-2">
                       {primaryCTA?.text || t('HERO_CTA_START')}
                       <svg className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                       </svg>
                     </span>
                                 ...
                                 {(secondaryCTA || showProductPreview) && (
                   secondaryCTA?.href ? (
                     ...
                     <Button 
                       size="lg" 
                       variant="outline"
                       onClick={secondaryCTA?.onClick || handleScroll}
                       className="border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:border-gray-400 dark:hover:border-gray-500 hover:text-gray-900 dark:hover:text-white font-semibold px-10 py-6 rounded-xl transition-all duration-300 transform hover:scale-105 group"
                     >
                       <span className="flex items-center gap-2">
                         {secondaryCTA?.text || t('HERO_CTA_PREVIEW')}
                         <svg className="w-5 h-5 transform group-hover:translate-y-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                         </svg>
                       </span>
        ...
        {showProductPreview && (
          <div 
            id="product-preview"
            className={cn(
              "relative max-w-7xl mx-auto transition-all duration-1000 delay-1100",
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            )}
          >
