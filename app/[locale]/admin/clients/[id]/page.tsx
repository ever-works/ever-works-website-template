          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-3">
              <Link
                ...
                className="inline-flex items-center px-2 py-1 bg-linear-to-r from-theme-primary to-theme-accent text-white shadow-lg hover:shadow-xl rounded transition-all duration-300"
              >
