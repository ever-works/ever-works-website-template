      ...
      <form id="payment-form" onSubmit={handleSubmit} className="w-full">
        <div className="space-y-6">
          ...
          <div className="relative">
            <div className="absolute -inset-1 bg-linear-to-r from-blue-600 to-purple-600 rounded-lg blur-sm opacity-20 animate-pulse"></div>
          ...
          {errorMessage && (
            <div className="relative">
              <div className="absolute -inset-1 bg-linear-to-r from-red-600 to-pink-600 rounded-lg blur-sm opacity-20"></div>
          ...
          {isProcessed && (
            <div className="relative">
              <div className="absolute -inset-1 bg-linear-to-r from-green-600 to-emerald-600 rounded-lg blur-sm opacity-20"></div>
          ...
          <div className="relative">
            <div className="absolute -inset-1 bg-linear-to-r from-blue-600 to-purple-600 rounded-lg blur-sm opacity-25 group-hover:opacity-50 transition duration-300"></div>
            <Button
              type="submit"
